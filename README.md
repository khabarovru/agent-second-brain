# Agent Second Brain (OpenClaw Fork)

[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](LICENSE)

> **OpenClaw-адаптированная версия** оригинального [agent-second-brain](https://github.com/smixs/agent-second-brain).
> Использует OpenClaw Gateway вместо Claude Code для обработки записей.
...
**⚠️ Требуется OpenClaw:** Эта версия работает через OpenClaw Gateway, а не через Claude Code.

### Быстрая установка (OpenClaw уже установлен)

Полная инструкция: **[INSTALL.md](INSTALL.md)**

```bash
# 1. Клонировать в OpenClaw workspace
...
# См. INSTALL.md для конфигурации

# 5. Установить systemd services
sudo cp deploy/*.{service,timer} /etc/systemd/system/
sudo systemctl daemon-reload
sudo systemctl enable --now d-brain-bot.service d-brain-process.timer d-brain-weekly.timer
```
...
| Your Telegram ID | [@userinfobot](https://t.me/userinfobot) | 30 сек |
...
### Для оригинальной версии (Claude Code)

См. [upstream репозиторий](https://github.com/smixs/agent-second-brain)
