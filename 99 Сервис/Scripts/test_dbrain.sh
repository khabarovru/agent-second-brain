...
if [ ! -d "$VAULT_PATH/99 Сервис/Skills/dbrain-processor" ]; then
...
if ! grep -q "80 Сводки" src/d_brain/services/processor.py; then
...
SKILL_FILE="$VAULT_PATH/99 Сервис/Skills/dbrain-processor/SKILL.md"
