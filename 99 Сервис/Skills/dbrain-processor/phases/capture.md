...
## Input
- `80 Ежедневные/{DATE}.md` — today's entries
- `60 Цели/3-weekly.md` — current week focus
- `60 Цели/2-monthly.md` — monthly priorities
- `60 Цели/1-yearly-2026.md` — yearly goals

## Task

1. Read `80 Ежедневные/{DATE}.md`
