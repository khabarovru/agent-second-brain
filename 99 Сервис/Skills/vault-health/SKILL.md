...
uv run 99 Сервис/Skills/graph-builder/scripts/analyze.py

# Regenerate MOC with explicit wikilinks
uv run 99 Сервис/Skills/vault-health/scripts/generate_moc.py

# Find who links to a file
bash 99 Сервис/Skills/vault-health/scripts/backlinks.sh "business/crm/acme-corp"

# Find and fix broken links (dry run)
uv run 99 Сервис/Skills/vault-health/scripts/fix_links.py

# Apply fixes
uv run 99 Сервис/Skills/vault-health/scripts/fix_links.py --apply
```
...
```markdown
- Acme Corp — Active, p1, Project $XXK, deadline YYYY-MM-DD
```
...
bash 99 Сервис/Skills/vault-health/scripts/backlinks.sh "MEMORY"
```
...
- [[99 Сервис/Skills/graph-builder/SKILL|graph-builder]] — core graph analysis (analyze.py)
- [[99 Сервис/Skills/dbrain-processor/SKILL|dbrain-processor]] — daily processing pipeline
