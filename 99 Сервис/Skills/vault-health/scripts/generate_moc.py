...
Output:
  - vault/90 Карты знаний/MOC-business.md — Business CRM Map of Content
  - vault/90 Карты знаний/MOC-projects.md — Projects Map of Content
...
MOC_DIR = VAULT_PATH / "90 Карты знаний"
